...
import { token_addresses as sepolia_addresses } from '../cache/addresses_draw_sepolia';
...
const getRegistryAddress = () => {
  if (network.name == "localhost") {
    ...
    return sepolia_addresses.registryAddress;
...
const chainId = (network.name == "sepolia") ? ChainId.Sepolia : ChainId.Mainnet;
