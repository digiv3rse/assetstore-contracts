...
interface OnChainCanvasCoreInterface extends ethers.utils.Interface {
  functions: {
...
export class OnChainCanvasCore extends BaseContract {
  ...
  interface: OnChainCanvasCoreInterface;
