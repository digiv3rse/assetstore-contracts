...
interface OnChainCanvasInterface extends ethers.utils.Interface {
  functions: {
    ...
    "mintWithAsset((string,string,string,string,address,bytes,tuple[]),uint256,uint256,tuple[],tuple[])": FunctionFragment;
...
export class OnChainCanvas extends BaseContract {
  ...
  interface: OnChainCanvasInterface;
