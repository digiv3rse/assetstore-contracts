...
interface SplatterTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class SplatterToken extends BaseContract {
  ...
  interface: SplatterTokenInterface;
  ...
  callStatic: {
    ...
    mint(_affiliate: BigNumberish, overrides?: CallOverrides): Promise<void>;
