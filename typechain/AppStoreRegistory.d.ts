...
interface AppStoreRegistoryInterface extends ethers.utils.Interface {
  functions: {
...
export class AppStoreRegistory extends BaseContract {
  ...
  interface: AppStoreRegistoryInterface;
