...
interface AssetStoreProviderInterface extends ethers.utils.Interface {
  functions: {
...
export class AssetStoreProvider extends BaseContract {
  ...
  interface: AssetStoreProviderInterface;
